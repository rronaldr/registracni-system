@extends('layouts.admin.main', ['title' => __('app.templates.template-edit-title')])
            ...
            <form action="{{ route('admin.templates.update', ['id' => $template->id]) }}" method="post"
                ...
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control rounded-0" name="name" value="{{ $template->name}}">
                        @error('name')
                ...
                <div class="row mb-3" id="contentDiv">
                    <div class="col">
                        ...
                        <textarea class="form-control rounded-0" rows="8" name="html">{{ $template->html }}</textarea>
                        @error('html')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
