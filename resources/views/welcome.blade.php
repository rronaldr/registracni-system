...
<head>
    ...
    <link href="{{ url('/vendor/fontawesome/css/fontawesome.min.css') }}" rel="stylesheet">
    <link href="{{ url('/vendor/fontawesome/css/solid.min.css') }}" rel="stylesheet">
    <link href="{{ url('/vendor/fontawesome/css/brands.min.css') }}" rel="stylesheet">
    <link href="{{ url('/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ url('/vendor/flagiconcss/css/flag-icon.min.css') }}" rel="stylesheet">
...
<script src="{{ url('/vendor/chartsjs/Chart.min.js') }}"></script>
<script src="{{ url('/js/admin/dashboard-charts.js') }}"></script>
