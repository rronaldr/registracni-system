...
class DateSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('dates')->insert([
            ...
            'enrollment_from' => Carbon::now(),
            'enrollment_to' => Carbon::now()->addDays(5),
            'withdraw_to' => Carbon::now()->addDays(5),
            'capacity' => 20,
            'substitute' => false,
        ]);
        ...
        DB::table('dates')->insert([
            ...
            'enrollment_from' => Carbon::now(),
            'enrollment_to' => Carbon::now()->addDays(10),
            'withdraw_to' => Carbon::now()->addDays(10),
            'capacity' => 100,
            'substitute' => false,
        ]);
