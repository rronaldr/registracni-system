...
Route::middleware(['auth', 'can:admin-access'])->group(function () {
    ...
    Route::middleware('can:event-access')->group(function () {
        ...
        Route::put('/events/{id}/update',
            [EventController::class, 'update'])->middleware('can:event-edit')->name('admin.events.update');
        Route::delete('/events/{id}',
            [EventController::class, 'destroy'])->middleware('can:event-delete')->name('admin.events.destroy');
        Route::post('/events/{id}/blacklist', [
            EventController::class, 'createAndGetBlacklistForEvent'
        ])->middleware('can:event-create')->name('admin.events.blacklist.store');
        Route::get('/events/{id}/duplicate',
            [EventController::class, 'duplicate'])->middleware('can:event-create')->name('admin.events.duplicate');
        Route::get('/events/{id}/users',
            [EventController::class, 'getEventEnrollmentsUsers'])->name('admin.events.users');
        Route::get('/events/{id}/tags', [EventController::class, 'getEventTags'])->name('admin.events.tags');
        Route::post('/events/{id}/tags/create',
            [EventController::class, 'storeEventTag'])->middleware('can:event-create')->name('admin.events.tags.store');
        Route::put('/events/{id}/tags/{tag}/update',
            [EventController::class, 'updateEventTag'])->middleware('can:event-edit')->name('admin.events.tags.update');
    ...
    Route::middleware('can:template-access')->group(function () {
        Route::get('/templates',
            [TemplateController::class, 'index'])->middleware('can:event-delete')->name('admin.templates');
        Route::get('/templates/create',
            [TemplateController::class, 'create'])->middleware('can:template-create')->name('admin.templates.create');
        Route::post('/templates/store',
            [TemplateController::class, 'store'])->middleware('can:template-create')->name('admin.templates.store');
        Route::get('/templates/{id}/edit',
            [TemplateController::class, 'edit'])->middleware('can:template-edit')->name('admin.templates.edit');
        Route::put('/templates/{id}',
            [TemplateController::class, 'update'])->middleware('can:template-edit')->name('admin.templates.update');
        Route::delete('/templates/{id}',
            [TemplateController::class, 'destroy'])->middleware('can:template-delete')->name('admin.templates.destroy');
        Route::post('templates/{id}/send-test',
    ...
    Route::get('templates/approved',
        [TemplateController::class, 'getApprovedTemplates'])->name('admin.templates.approved');
    ...
    Route::middleware('can:user-access')->group(function () {
        ...
        Route::get('/users/{id}/roles',
            [UserController::class, 'getUserByIdWithRoles'])->name('admin.users.roles.list');
        Route::post('/users/{id}/roles/assign',
            [UserController::class, 'assignRole'])->name('admin.users.roles.assign');
        Route::post('/users/{id}/roles/revoke',
            [UserController::class, 'revokeRole'])->name('admin.users.roles.revoke');
    });

    // Export routes
    Route::get('/events/{id}/users/export',
    ...
    Route::get('/dates/{id}/users/export',
        [ExcelController::class, 'exportDateUsers'])->name('admin.dates.users.export');
    Route::get('/dates/{id}/users/export-email',
        [ExcelController::class, 'exportDateUsersEmail'])->name('admin.dates.users.export.email');
